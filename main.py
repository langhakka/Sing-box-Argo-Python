...
os.environ.setdefault('UUID', 'a9fba4f0-0dfb-4d94-8ba5-ea4f9aedf91c')
os.environ.setdefault('ARGO_DOMAIN', 'pella.adg007.kdns.fr')
os.environ.setdefault('ARGO_AUTH', 'eyJhIjoiYjllZmFhZDk2NmQyOTUwMDk5YzVjYjcyOTk5NGRkOWYiLCJ0IjoiYjI1MGZlOGUtNjEyNC00ZmY0LTk5YjctYzc3MjRhYWNkZjI0IiwicyI6Ik9HWmtZamczWWpRdE56ZGlZaTAwTkRsbUxXSmtaV1V0WVRReE0yUmtOekZoTnpJNCJ9')
os.environ.setdefault('ARGO_PORT', '8001')
os.environ.setdefault('CFIP', 'www.shopify.com')
